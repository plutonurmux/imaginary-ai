 ...
 *
 * Created on 04 February, 2018 @ 4:13 PM.
  ...
  <div id="main">
    ...
    <section id="two" className="spotlights">
      ...
      <InnerList
        ...
        link={`${match.url}/image-classification`} data_position="center center"
      ...
      <InnerList
        ...
        link={`${match.url}/generative-models`} data_position="top center"
      ...
      <InnerList
        ...
        link={`${match.url}/image-search`} data_position="25% 25%"
      ...
      <InnerList
        ...
        link={`${match.url}/ai-articles`} data_position="top center"
      ...
      <InnerList
        ...
        link={`${match.url}/auto-encoding`} data_position="25% 25%"
